...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            ...
            <?php endif; ?>
            <p>To learn about stand alone documents, you can visit this <a href="https://wpe.approveme.com/article/156-basic-document-vs-stand-alone-document/?utm_source=wprepo&utm_medium=link&utm_campaign=fluent-forms" target="_blank">helpful article</a></p>
        </div>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            <h4><span class="esig-step">5a</span> (optional) Insert fluent forms User Data into a Contract</h4>
            ...
            <ol>
                <li>Navigate to the Signer Input Fields/Custom Fields icon and select "Fluent Forms Data".</li>


                <li>Select the Fluent Form that you have already created (and would like to connect to your contract) using the dropdown menu.</li>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        ...
        <div class="approveme-column-2">
            ...
            <p>After you have entered all of your desired contract text and have connected your desired Fluent Forms field results to your Stand Alone Document, you are ready to choose/define your document options.</p>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            ...
            <p>Once you've published your Stand Alone Document you are 50% complete. The next step is you will need to choose your "trigger" and "action" options for this document in fluent forms.</p>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        ...
        <div class="approveme-column-2">
            <h4><span class="esig-step">7</span> Finish setting up the Fluent Forms workflow/trigger</h4>
            ...
            <p>To view a live fluent to WP E-Signature demo you can check one out at:</p>
            <div align="center">
                <div class="approveme-btn"><a class="button-border" href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=fluent-forms">Try a Live Demo of this Integration</a></div>
            </div>
            <br>
        </div>
    </div>
