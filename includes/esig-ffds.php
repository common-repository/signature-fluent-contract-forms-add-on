...
class ESIG_FFDS {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'esig-ffds';
	...
	private static function single_activate() {
		//@TODO: Define activation functionality here
         if(get_option('WP_ESignature__Fluent_Forms_Digital_Signature_documentation'))
        {
            update_option('WP_ESignature__Fluent_Forms_Digital_Signature_documentation','');
            
        }
        else
        {
           
           add_option('WP_ESignature__Fluent_Forms_Digital_Signature_documentation','');
        }
	}
